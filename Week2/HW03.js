...
let shader;
let vao;
let horizontal_move = 0.0;
let vertical_move = 0.0;
...
function setupKeyboardEvents() {
    document.addEventListener('keydown', (event) => {
        if (event.key == 'ArrowUp') {
            ...
            if (horizontal_move >= -0.9) {
                horizontal_move += -0.01;
            }
...
function render(vao, shader) {
    ...
    shader.setFloat("horizontal", horizontal_move);
    shader.setFloat("vertical", vertical_move);
